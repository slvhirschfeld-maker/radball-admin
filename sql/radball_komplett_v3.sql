...
-- ============================================================
-- 16. TOURNAMENT_MATCHES – Neue Spalten für Spielmodus
-- (nur ausführen wenn tournament_matches bereits existiert)
-- ============================================================
...
-- Status 'tbd' erlauben (für K.O.-Platzhalter)
ALTER TABLE tournament_matches
  ALTER COLUMN status SET DEFAULT 'scheduled';

-- Tournaments: Spielmodus-Spalte
ALTER TABLE tournaments
  ADD COLUMN IF NOT EXISTS mode VARCHAR(20) DEFAULT 'round_robin';
  -- round_robin | groups_ko | ko_only